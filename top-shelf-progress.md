...
- **Soft-deadlock is skipped on layered levels** (like wildcard) — the per-move solve is too heavy for the main thread; build-time solver-gate + hard-deadlock + timer still cover it.
